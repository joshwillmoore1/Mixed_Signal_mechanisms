...
AdjMatrixVN = bilayer_Adj_Matrix_periodic_VN_weighted(NumOfLuminal, 1,w1_Delta,w2_Delta);
AdjMatrixVN_type2 = bilayer_Adj_Matrix_periodic_VN_weighted(NumOfLuminal, 1,w1_Ecad,w2_Ecad);
...
for k = 1:length(dt(end))
    ...
    scatter(FullCells(:,1),FullCells(:,2),MarkerSize,y(dt(end),1:3:end-2),'filled','linewidth',1,'MarkerEdgeColor','k')
    axis equal
    axis off
